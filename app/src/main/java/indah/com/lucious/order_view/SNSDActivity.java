...
public class SNSDActivity extends AppCompatActivity {

    TextView mTextHarga,mTextQty, albumsnsd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snsd);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        albumsnsd = (TextView) findViewById(R.id.albumsnsd);
